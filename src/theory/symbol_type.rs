...
pub enum SymbolAttribute {
  ...
  Object       = 0x200,
  Message      = 0x400,
  MsgStatement = 0x800, /* MESSAGE flag was set by msg statement rather than an attribute; only used by
                         * SyntacticPreModule */
...
impl SymbolAttribute {
  ...
  const Collapse: SymbolType =
    SymbolType(SymbolAttribute::LeftId as u32 | SymbolAttribute::RightId as u32 | SymbolAttribute::Idem as u32);
